"""
Django settings for bemosenderrr project.
...
AUTH_USER_MODEL = 'bemosenderrr.User'
...
JWT_AUTH = {
    'JWT_PAYLOAD_GET_USERNAME_HANDLER': 'bemosenderrr.utils.jwt.get_username_from_payload_handler',
    'JWT_DECODE_HANDLER': 'bemosenderrr.utils.jwt.cognito_jwt_decode_handler',
...
DEFAULT_FROM_EMAIL = CONFIG['SMTP_senderr']
...
CSRF_TRUSTED_ORIGINS = [CONFIG['DOMAIN_ROOT'], "wks-stan.bemosenderrr.dev"]
...
if ENV == "Prod-V3":
    ...
    #     "https://bemosenderrr.io",
    #     "https://app.bemosenderrr.io",
    ...
    CACHE_MIDDLEWARE_SECONDS = 0
    # DEFAULT_FROM_EMAIL = 'no-reply@bemosenderrr.app'
    # EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
...
# CACHALOT_UNCACHABLE_TABLES = ('django_migrations', 'bemosenderrr_value', 'django_session')
...
if ENV == "Dev-V3":
    EMAIL_PAGE_DOMAIN = 'https://bemosenderrr.dev/'
elif ENV == "Prod-V3":
    EMAIL_PAGE_DOMAIN = 'https://bemosenderrr.app/'
else:
    EMAIL_PAGE_DOMAIN = 'https://bemosenderrr.dev/'
...
INSTALLED_APPS = [
    ...
    'bemosenderrr.apps.bemosenderrrConfig',
...
MIDDLEWARE = [
    ...
    'bemosenderrr.middleware.SetRemoteAddrFromForwardedFor',
...
ROOT_URLCONF = 'bemosenderrr.urls'
...
REST_FRAMEWORK = {
    'DEFAULT_VERSIONING_CLASS': 'bemosenderrr.versioning.bemosenderrrVersioning',
    ...
    'DEFAULT_PAGINATION_CLASS': 'bemosenderrr.pagination.ResultSetPagination',
    ...
    'EXCEPTION_HANDLER': 'bemosenderrr.exceptions.custom_exception_handler',
...
# REST_AUTH_REGISTER_SERIALIZERS = {'REGISTER_SERIALIZER': 'bemosenderrr.serializers.auth.bemosenderrrRegisterSerializer'}

# bemosenderrr.dev/o/application
# OAUTH2_PROVIDER = {
...
LOGGING = {
    ...
    'filters': {
        'special': {
            '()': 'bemosenderrr.logger.IgnoreFilter',
...
XRAY_RECORDER = {
    'AWS_XRAY_TRACING_NAME': '{0}-{1}-bemosenderrr-Backend'.format(KEY, ENV),
    'PATCH_MODULES': [
        'boto3',
        'requests',
        # 'bemosenderrr.views',
...
CELERY_TASK_ROUTES = {
    "bemosenderrr.models.partner.bank_verification.verify": {'queue': 'verification'},
    "bemosenderrr.models.partner.base.ping": {'queue': 'send_money'},
    "bemosenderrr.models.partner.currconv.get_rates": {'queue': 'periodic_tasks'},
    "bemosenderrr.models.partner.kyc_verification.verify": {'queue': 'verification'},
    "bemosenderrr.models.partner.transactions.cancel": {'queue': 'send_money'},
    "bemosenderrr.models.partner.transactions.check_collect_status": {'queue': 'periodic_tasks'},
    "bemosenderrr.models.partner.transactions.collect": {'queue': 'send_money'},
    "bemosenderrr.operations.collect_transactions": {'queue': 'send_money'},
    "bemosenderrr.operations.fund_transaction": {'queue': 'send_money'},
    "bemosenderrr.tasks.add": {'queue': 'periodic_tasks'},
    "bemosenderrr.tasks.authorize_deposits": {'queue': 'periodic_tasks'},
    "bemosenderrr.tasks.update_pending_sign_up_flinks": {'queue': 'verification'},
    "bemosenderrr.tasks.check_deposits": {'queue': 'periodic_tasks'},
    "bemosenderrr.tasks.check_refunds": {'queue': 'periodic_tasks'},
    "bemosenderrr.tasks.get_interac_emails": {'queue': 'invoices'},
    "bemosenderrr.tasks.send_invoice_task": {'queue': 'invoices'},
    "bemosenderrr.tasks.update_rates": {'queue': 'periodic_tasks'},
    "bemosenderrr.tasks.user_bank_verify": {'queue': 'verification'},
    "bemosenderrr.models.partner.transactions.check_funding_inactivity": {'queue': 'periodic_tasks'}
}
